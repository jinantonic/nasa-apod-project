...
function SpaceBackground() {
  // Define orbit rings with unique classNames and colors
  const orbits = [
  ...
  return (
    <div className="space-scene">
      ...
      {/* Render orbit rings with colored borders and planets */}
      ...
      {/* Generate 500 stars randomly positioned within the container */}
      {[...Array(500)].map((_, i) => {
